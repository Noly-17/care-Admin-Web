...
class TranferedRequest extends React.Component {
    state = {
        users: null,
        userId: null,
        lat: null,
...
export default connect(mapStateToProps, mapDispatchToProps)(TranferedRequest);
